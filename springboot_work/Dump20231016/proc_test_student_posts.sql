...
CREATE TABLE `student_posts` (
  ...
  KEY `student_posts_ibfk_1` (`post_writer`),
  CONSTRAINT `student_posts_ibfk_1` FOREIGN KEY (`post_writer`) REFERENCES `student` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `student_posts` VALUES (4,'ㄹ',NULL);
